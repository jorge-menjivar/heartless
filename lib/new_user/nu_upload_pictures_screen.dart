...
class UploadPicturesScreen extends StatefulWidget {
  ...
  @override
  UploadPicturesScreenState createState() =>
      UploadPicturesScreenState(user: user);
}
                    ...
                    child: SizedBox(
                        ...
                        child: RawMaterialButton(
                          ...
                          child: _imageOrPlaceHolder(
                              pictureMissing1, _profilePicImageLink1),
                          onLongPress: () {},
                          onPressed: () {
                  ...
                  Center(
                    child: SizedBox(
                        ...
                        child: RawMaterialButton(
                          ...
                          padding: EdgeInsets.all(4),
                          child: _imageOrPlaceHolder(
                              pictureMissing2, _profilePicImageLink2),
                          onLongPress: () {},
                          onPressed: () {
                  ...
                  Center(
                    child: SizedBox(
                        ...
                        child: RawMaterialButton(
                          ...
                          padding: EdgeInsets.all(4),
                          child: _imageOrPlaceHolder(
                              pictureMissing3, _profilePicImageLink3),
                          onLongPress: () {},
                          onPressed: () {
                  ...
                  Center(
                    child: SizedBox(
                        ...
                        child: RawMaterialButton(
                          ...
                          padding: EdgeInsets.all(4),
                          child: _imageOrPlaceHolder(
                              pictureMissing4, _profilePicImageLink4),
                          onLongPress: () {},
                          onPressed: () {
                  ...
                  Center(
                    child: SizedBox(
                        ...
                        child: RawMaterialButton(
                          ...
                          padding: EdgeInsets.all(4),
                          child: _imageOrPlaceHolder(
                              pictureMissing5, _profilePicImageLink5),
                          onLongPress: () {},
                          onPressed: () {
  ...
  Widget _imageOrPlaceHolder(bool pictureMissing, String profilePicImageLink) {
    return Container(
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(18.0), color: Colors.red),
